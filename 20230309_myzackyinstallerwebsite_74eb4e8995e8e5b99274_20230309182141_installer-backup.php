...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = '20230309_myzackyinstallerwebsite_74eb4e8995e8e5b99274_20230309182141_archive.zip';
        const ARCHIVE_SIZE       = '31316975';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = '74eb4e8-09182141';
        const SECONDARY_PACKAGE_HASH = 'e26f473-09182141';
